...
// src/data/heroData.js
// NOTE: The floating icons below are hidden on screens smaller than xl (1280px)
// via the parent container in Hero.jsx ("hidden xl:block").
// This prevents them from overflowing at 1024-1279px screen widths.
...
export const heroImages = [
  {
    src: bracket_icon,
    className:
      "absolute w-[auto] 2xl:h-[77px] xl:h-[71px] h-[66px] top-[53%] xl:top-[52%] 2xl:top-[50%] right-[28.5%] 2xl:right-[30%] opacity-[70%] object-contain bg-[#d6b4ffa1] rounded-[15px] p-2",
  },
  {
    src: angle,
    className:
      "absolute w-[auto] 2xl:h-[45px] xl:h-[41px] h-[38px] top-[72%] right-[29.5%] 2xl:right-[30.5%] opacity-[80%] object-contain bg-[#ffa0e6d5] rounded-[15px] p-2",
  },
  {
    src: square,
    className:
      "absolute 2xl:w-[55px] xl:w-[51px] w-[48px] h-auto top-[62%] right-[33.5%] 2xl:right-[35%] opacity-[85%] object-contain bg-[#a0fcffb6] rounded-[15px] p-2",
  },
  {
    src: pc6,
    className:
      "absolute w-auto 2xl:h-[150px] xl:h-[138px] h-[130px] bottom-[3%] right-[12%] xl:right-[13%] 2xl:right-[14%] opacity-[54%] object-contain bg-[#aaa7fff5] rounded-[15px] p-2",
  },
  {
    src: pc2,
    className:
      "absolute 2xl:w-[250px] xl:w-[225px] w-[210px] 2xl:h-[160px] xl:h-[148px] h-[140px] top-[54%] xl:top-[51%] 2xl:top-[48%] right-[7%] xl:right-[8%] 2xl:right-[10%] opacity-[50%] object-contain bg-[#f0b4ffcd] rounded-[15px] p-2",
  },
  {
    src: cube2,
    className:
      "absolute 2xl:w-[70px] xl:w-[64px] w-[59px] h-auto top-[35%] xl:right-[40%] 2xl:right-[42%] right-[38%] object-contain",
  },
  {
    src: cube2,
    className:
      "absolute 2xl:w-[100px] xl:w-[90px] w-[84px] h-auto top-[73%] xl:top-[62%] xl:right-[45%] 2xl:right-[48%] right-[50%] object-contain",
  },
  {
    src: mobile2_icon,
    className:
      "absolute w-[auto] 2xl:h-[140px] xl:h-[138px] h-[130px] bottom-[3%] right-[27%] xl:right-[27%] 2xl:right-[28%] opacity-[50%] object-contain bg-[#ffd0b4] border-none rounded-[15px] p-2",
  },
];
