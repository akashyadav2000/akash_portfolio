...
export default function AboutMe() {
  ...
  return (
    <section
      ...
      style={{
        background: isDark
          ? "linear-gradient(135deg,#030f0e 0%,#0a1a15 50%,#050e10 100%)"
          : undefined,
      }}
    >
      {!isDark && (
        <div className="absolute inset-0 -z-10">
          <div className="w-full h-full bg-gradient-to-br from-[#8dfff7]/50 via-[#fdf5e6]/60 to-[#ffeddd]/40" />
        </div>
      )}
      ...
      <motion.h2
        ...
        animate={inView ? { opacity: 1, y: 0 } : {}}
        transition={{ duration: 0.6 }}
        className={`w-full text-center 2xl:text-[34px] xl:text-[30px] lg:text-[27px] text-[22px] font-[800] mb-6 xl:mb-[3%] tracking-tight flex-shrink-0
          ${isDark ? "text-white" : "text-gray-900"}`}
      >
        About{" "}
        <span className={isDark ? "text-emerald-400" : "text-pink-500"}>
          Me
        </span>
      </motion.h2>

      <div className="w-full max-w-[1536px] flex flex-col md:flex-row md:items-center gap-12 md:gap-6 lg:gap-12 xl:gap-14 2xl:gap-16">
        {/* Image */}
        <motion.div
        ...
        >
          <div className="relative w-[42%] sm:w-[38%] md:w-[80%] lg:w-[82%] xl:w-[80%] 2xl:w-[75%] mx-auto mt-6 md:mt-20 lg:mt-24 xl:mt-24 mb-0 md:mb-8">
            <div
              ...
              ${
                isDark
                  ? "bg-gradient-to-b from-emerald-600/70 to-teal-700/70 shadow-[0_0_40px_rgba(16,185,129,0.25)]"
                  : "bg-gradient-to-b from-[#fba0e3] to-[#ff51ff]"
              }`}
            >
              <div
                className={`w-full h-full ${isDark ? "bg-[#030f0e]" : "bg-white"}`}
              >
                <div className="w-full h-full bg-gray-200/20 flex items-end justify-center overflow-visible">
                  <img
                    src={profileImage}
                    alt="Akash Yadav"
                    loading="lazy"
            ...
            {aboutStats.map((stat, i) => {
              ...
              return (
                <motion.div
                  ...
                  animate={inView ? { opacity: 1, scale: 1 } : {}}
                  transition={{ delay: 0.4 + i * 0.15, duration: 0.5 }}
                  className={`absolute ${pos} border rounded-xl text-center z-30 transition-all duration-300 hover:scale-110 shadow-lg
                    px-[6px] py-[4px] sm:px-[9px] sm:py-[6px] md:px-[11px] md:py-[7px] lg:px-[13px] lg:py-[8px] xl:px-[17px] xl:py-[11px]
                    ${isDark ? "bg-[#0a1a15]/90 border-emerald-500/30 shadow-emerald-500/10" : "bg-white/90 border-cyan-200"}`}
                >
                  <p
                    className="font-[800] leading-snug text-[10px] sm:text-[12px] md:text-[13px] lg:text-[15px] xl:text-[17px]"
                    style={{ color: stat.color }}
                  >
                    {stat.value}
                  </p>
                  <p
                    className={`font-[500] leading-snug whitespace-nowrap text-[8px] sm:text-[10px] md:text-[11px] lg:text-[12px] xl:text-[13px]
        ...
        >
          {[
            ...
            <motion.div
              ...
              animate={inView ? { opacity: 1, y: 0 } : {}}
              transition={{ delay: 0.3 + i * 0.15, duration: 0.55 }}
            >
              {block.heading && (
                <h4
                  className={`font-[700] mb-2 tracking-tight text-[14px] sm:text-[15px] lg:text-[17px] xl:text-[21px]
                  ${isDark ? "text-emerald-300" : "text-[#032255]"}`}
                >
                  {block.heading}
                </h4>
              )}
              <p
                className={`font-[400] leading-[1.8] mb-3 text-[13px] sm:text-[14px] lg:text-[15px] xl:text-[17px]
              ...
              {i < 2 && (
                <div
                  className={`my-3 xl:my-4 h-px bg-gradient-to-r from-transparent ${isDark ? "via-emerald-500/50" : "via-cyan-300"} to-transparent`}
                />
              )}
            </motion.div>
          ))}
          ...
          >
            <button
              onClick={() => scrollToSection("contact")}
              className={`px-6 py-[10px] rounded-xl font-[700] text-[13px] tracking-wide transition-all duration-300 border-2
                ${
                  isDark
                    ? "border-emerald-500 text-emerald-400 hover:bg-emerald-500 hover:text-[#030f0e]"
                    : "bg-[#2ef6e9] text-gray-800 border-transparent hover:bg-white hover:text-cyan-600 hover:border-cyan-400"
                }`}
            >
              Hire Me
            </button>
              ...
              className={`px-6 py-[10px] rounded-xl font-[700] text-[13px] tracking-wide transition-all duration-300 border-2
                ${
                  isDark
                    ...
                    : "bg-white text-fuchsia-600 border-fuchsia-400 hover:bg-fuchsia-500 hover:text-white hover:border-fuchsia-500"
                }`}
            >
              My Resume
            </a>
