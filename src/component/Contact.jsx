...
function Contact() {
  ...
  return (
    <>
      <div className="relative min-h-fit xl:min-h-[calc(100dvh-55px)] flex items-center justify-center flex-col px-[4%]">
        ...
        <div className="flex md:flex-row flex-col-reverse gap-[35px] 2xl:gap-[40px] px-[25px] py-[25px] xl:px-[30px] 2xl:px-[50px] xl:py-[20px] 2xl:py-[30px] p-[20px] rounded-md overflow-hidden bg-[#e6ffe6a7] border-1 border-[#00c41d] max-w-[1500px]">
          {/* Left: Form */}
          <div className="lg:w-2/3 xl:w-1/2 w-full">
            <div className="flex items-center gap-[20px] md:text-left text-center mb-[20px]">
              ...
              <p className="text-[#222222] font-[500] text-justify text-[14.5px] sm:text-[16px] md:text-[17px] hidden sm:block">
            ...
            <form onSubmit={handleSubmit} ref={formRef}>
              <div className="relative mb-4">
                <FaUser className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#00aa19] text-[18px] xl:text-[19px] 2xl:text-[20px]" />
                <input
                  className="w-full pl-10 outline-none p-[9px] bg-[#f8f8ff] text-[#222222] placeholder:text-gray"
                  type="text"
                  name="name"
              ...
              <div className="relative mb-4">
                <MdEmail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#00aa19] text-[18px] xl:text-[19px] 2xl:text-[20px]" />
                <input
                  className="w-full pl-10 rounded-md outline-none p-[9px] bg-[#f8f8ff] text-[#222222] placeholder:text-gray"
                  type="email"
                  name="email"
              ...
              <div className="relative mb-4">
                <BiMessageDetail className="absolute left-3 top-[22px] transform -translate-y-1/2 text-[#00aa19] text-[18px] xl:text-[19px] 2xl:text-[20px]" />
                <textarea
                  className="w-full pl-10 outline-none p-[9px] bg-[#f8f8ff] text-[#222222] placeholder:text-gray resize-none h-[130px] sm:h-[160px] break-words whitespace-pre-wrap"
